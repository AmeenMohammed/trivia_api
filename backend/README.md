...
- Example: `curl -H "Content-Type: application/json" -X POST -d'{"question":"Hello?","answer":"Hi","difficulty":"2","category":"2"}' http://127.0.0.1:5000/questions (bash)`
```
{
    "created": 26, 
    "success": true
...
- Example: `curl -H "Content-Type: application/json" -X POST -d'{"searchTerm":"Hello"}' http://127.0.0.1:5000/questions/search` 
```
{
    "current_category": null,
    "questions": [
...
- Example: `curl -H "Content-Type: application/json" -X POST -d '{"previous_questions":["1","2"],"quiz_category":{"type":"click","id":"0"}}' http://127.0.0.1:5000/quizzes` 
